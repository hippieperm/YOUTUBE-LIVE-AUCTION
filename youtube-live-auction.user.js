  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <ProtectScenarios>False</ProtectScenarios>
    ...
    function openUnifiedPriceModal() {
        ...
        const inputWrap = createElement('div', { style:'display:flex !important; align-items:center !important; gap:8px !important; margin-top:14px !important;' }); const unit=createElement('span',{text:'만원',style:'font-size:14px !important; font-weight:800 !important; color:#cbd5e1 !important;'});
        ...
        inputWrap.appendChild(makeStepButton('-1만',-1)); inputWrap.appendChild(input); inputWrap.appendChild(unit); modal.appendChild(tabs); modal.appendChild(inputWrap);
        ...
        quick.appendChild(makeStepButton('+1만',1)); quick.appendChild(makeStepButton('+5만',5)); quick.appendChild(makeStepButton('+10만',10)); modal.appendChild(quick);
