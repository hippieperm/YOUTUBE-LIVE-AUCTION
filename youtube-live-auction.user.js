  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   ...
   <ProtectScenarios>False</ProtectScenarios>
    ...
    function openUnifiedPriceModal() {
        ...
        const input = createElement('input', { type:'text', inputmode:'decimal', placeholder:'금액 입력', style:'flex:1 !important; width:100% !important; height:48px !important; box-sizing:border-box !important; padding:0 14px !important; border:1px solid rgba(148,163,184,.3) !important; border-radius:12px !important; background:rgba(8,15,30,.85) !important; color:#fff !important; -webkit-text-fill-color:#fff !important; font-size:18px !important; font-weight:800 !important; outline:none !important;' });
        ...
        const quick=createElement('div',{style:'display:grid !important; grid-template-columns:repeat(3,1fr) !important; gap:7px !important; margin-top:12px !important;'}); [1,5,10].forEach(value=>{const b=createElement('button',{type:'button',text:`+${value}만`,style:'height:42px !important; border:1px solid rgba(250,204,21,.35) !important; border-radius:11px !important; background:rgba(250,204,21,.1) !important; color:#fde68a !important; font-size:13px !important; font-weight:900 !important; cursor:pointer !important;'}); b.addEventListener('click',()=>{const current=parseFloat(input.value.replace(/,/g,''))||0;input.value=String(current+value);input.focus();});quick.appendChild(b);}); modal.appendChild(quick);
